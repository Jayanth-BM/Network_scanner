...
try:
    import psutil  # Try importing psutil library
    import termcolor  # Try importing termcolor library for colored output
except:
    # If the import fails, install the necessary libraries using pip
